...
public class UserController {
	...
	public @ResponseBody String login(@PathVariable("login") String securityCode, UserBean user,HttpSession session) {
		String str = "";
		UserBean userBean = userGetServiceImpl.getUser(user);
		//数据库中是否有该账户
		if(userBean != null && randomCode.toString().toLowerCase().equals(securityCode.toLowerCase())) {
