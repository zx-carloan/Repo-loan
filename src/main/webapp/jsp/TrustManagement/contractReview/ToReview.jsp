		...
		<form id="vehicleInfo" method="post">
			<table class="table1" border="1">
				...
				<tr class="tr1">
					...
					<td class="td1"><input type="text" readonly="readonly" name="contractNumber"></td>
					<td class="td1"><label>借款人</label></td>
					<td class="td1"><input type="text" readonly="readonly" name="client.loanName"></td>
				</tr>
				<tr class="tr1">
					<td class="td1"><label>借款人手机</label></td>
					<td class="td1"><input type="text" readonly="readonly" name="client.cellphone"></td>
					<td class="td1"><label>业务经理</label></td>
					<td class="td1"><input type="text" readonly="readonly" name="manager"></td>
				</tr>
				<tr class="tr1">
					<td class="td1"><label>借款用途</label></td>
					<td class="td1"><input type="text" readonly="readonly" name="client.loanPurpose"></td>
					<td class="td1"><label>职务</label></td>
					<td class="td1"><input type="text" readonly="readonly" name="client.position"></td>
				</tr>
				<tr class="tr1">
					<td class="td1"><label>身份证号</label></td>
					<td class="td1"><input type="text" readonly="readonly" name="client.identity"></td>
					<td class="td1"><label>所属分公司</label></td>
					<td class="td1"><input type="text" readonly="readonly" name="company.name"></td>
				</tr>
				<tr class="tr1">
				...
				<tr class="tr1">
					...
					<td class="td1" colspan="3"><textarea row="3" cols="60" readonly="readonly" name="">
               </textarea ></td>
				</tr>
			</table>
