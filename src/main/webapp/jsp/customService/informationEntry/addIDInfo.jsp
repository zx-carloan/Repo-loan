...
<body>
	...
	<div class="easyui-panel" style="width: 100%; text-align: center">
		<form id="add" method="POST" onsubmit="return submits()">
			<table class="table1" border="1">
				<tr class="tr1">
					<td class="td1"><label>姓名 <span style="color: red">*</span></label></td>
					<td class="td1"><input class="easyui-validatebox" id="name" name="name"
				...
				<tr class="tr1">
					...
					<td class="td1"><input name="birthday" class="easyui-validatebox" id="birth"
						class="test" type="date"> <span id="birthSpan"
						style="color: red; position: absolute;"></span></td>
				</tr>
				<tr class="tr1">
					<td class="td1"><label>地址 <span style="color: red">*</span></label></td>
					<td class="td1" colspan="3"><input id="address" type="text" name="address"
